/**
 * Header: /mgi/cvsroot/mgi/mtb/mtbei/src/org/jax/mgi/mtb/ei/dialogs/CurvesPanel.java,v 1.1 2007/04/30 15:50:43 mjv Exp
 * Author: mjv
 */
...
/**
 * A <code>GradientPanel</code> with curves.
 *
 * @author mjv
 * @date 2007/04/30 15:50:43
 * @version 1.1
 * @cvsheader /mgi/cvsroot/mgi/mtb/mtbei/src/org/jax/mgi/mtb/ei/dialogs/CurvesPanel.java,v 1.1 2007/04/30 15:50:43 mjv Exp
 */
public class CurvesPanel extends GradientPanel {
     ...
     * @param y1 original y1 position
     * @param y1_offset y position offset
     * @param y2 original y2 position
     * @param y2_offset y2 position offset
     * @param cx1 first control for curve
     * @param cx1_offset first x control for curve offset
     * @param cy1 first y control for curve
     * @param cy1_offset first y control for curve offset
     * @param cx2 second x control for curve
     * @param cx2_offset second x control for curve offset
     * @param cy2 second y control for curve
     * @param cy2_offset second y control for curve offset
     * @param thickness line thickness
     * @param speed speed used for position offset
     * @param invert whether the circle should be inverted or not
     */
    private void drawCurve(Graphics2D g2,
        ...
        CubicCurve2D curve = new CubicCurve2D.Double(start_x, start_y,
                ctrl1_x, ctrl1_y,
                ctrl2_x, ctrl2_y,
                end_x, end_y);
