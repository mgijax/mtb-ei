/**
 * Header: /mgi/cvsroot/mgi/mtb/mtbei/src/org/jax/mgi/mtb/ei/renderers/AssayImageDTOCellRenderer.java,v 1.1 2007/04/30 15:51:00 mjv Exp
 * Author: sbn
 */
...
/**
 * The default renderer for tables containg Assay Image DTO data.
 *
 * @author sbn
 * @date 2008/11/04 15:51:00
 * @version 1.1
 * @cvsheader /mgi/cvsroot/mgi/mtb/mtbei/src/org/jax/mgi/mtb/ei/renderers/AssayImageDTOCellRenderer.java,v 1.1 2007/04/30 15:51:00 mjv Exp
 */
public class AssayImageDTOCellRenderer extends JLabel implements TableCellRenderer {
     ...
     * Constructor
     */
    public AssayImageDTOCellRenderer() {
        super(); 
        this.setOpaque(true);
    ...
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        try {
            ...
            if (obj == null) {
                ...
                // the image may be allready exist but if there is no TGC key
                // it needs to be saved to create an association
                } else if (!dto.getDataBean().containsKey(EIConstants.ASSAY_IMAGE_TGC_KEY)) {
