/**
 * Header: /mgi/cvsroot/mgi/mtb/mtbei/src/org/jax/mgi/mtb/ei/listeners/LVBeanListListener.java,v 1.1 2007/04/30 15:50:47 mjv Exp
 * Author: mjv
 */
 ...
 * @version 1.1
 * @cvsheader /mgi/cvsroot/mgi/mtb/mtbei/src/org/jax/mgi/mtb/ei/listeners/LVBeanListListener.java,v 1.1 2007/04/30 15:50:47 mjv Exp
 * @see java.awt.event.KeyListener
 */
public class LVBeanListListener<L,V> implements KeyListener {
    ...
    public int getNextMatch(LVBeanListModel<L,V> model, String prefix, 
        ...
        do {
            ...
            if (o != null) {
                LabelValueBean<L,V> bean = (LabelValueBean<L,V>)o;
                String string = bean.getLabel().toString();
