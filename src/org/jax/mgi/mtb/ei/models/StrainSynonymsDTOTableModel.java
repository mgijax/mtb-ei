/**
 * Header: /mgi/cvsroot/mgi/mtb/mtbei/src/org/jax/mgi/mtb/ei/models/StrainSynonymsDTOTableModel.java,v 1.1 2007/04/30 15:50:50 mjv Exp
 * Author: mjv
 */
...
import org.jax.mgi.mtb.ei.comparators.StrainSynonymsDTOTableModelComparator;

/**
 * A <code>TableModel</code> which extends <code>DTOTableModel</code> and is
 * used to model <code>StrainSynonymsDTO</code> objects and ancillary data.
 *
 * @author mjv
 * @date 2007/04/30 15:50:50
 * @version 1.1
 * @cvsheader /mgi/cvsroot/mgi/mtb/mtbei/src/org/jax/mgi/mtb/ei/models/StrainSynonymsDTOTableModel.java,v 1.1 2007/04/30 15:50:50 mjv Exp
 */
public class StrainSynonymsDTOTableModel<T extends StrainSynonymsDTO> extends DTOTableModel<T> {
     ...
     */
    public StrainSynonymsDTOTableModel(List<T> arr, List<String> columnNames) {
    ...
    public void sortColumn(int col, boolean ascending) {
        if (arr != null) {
            Collections.sort(arr, 
                             new StrainSynonymsDTOTableModelComparator<T>(col, 
                                                                   ascending));
        }
    }
